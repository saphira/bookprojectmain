...
public class MainActivity extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//star views
		stars=(RatingBar)findViewById(R.id.book_rating_stars);
		...
		if (scanningResult != null) {
			...
			if(scanContent!=null && scanFormat!=null && scanFormat.equalsIgnoreCase("EAN_13")){
				...
				String bookSearchString = "https://www.googleapis.com/books/v1/volumes?" +
						"q=isbn:"+scanContent+"&key=AIzaSyA-Vh-qPLHRPoFQjEjWcK22KmeIh1t0sWc";
	...
	protected void onSaveInstanceState(Bundle savedBundle) {
		...
		savedBundle.putInt("stars",(int) stars.getRating());
